<?php
    ...
    if($_POST){
        if($_POST['method'] == 'tambah'){
            ...
            $sql = "INSERT INTO informasi (nama, keterangan, id_jenis_informasi , date) VALUES ('".$_POST['nama']."', '".$_POST['keterangan']."', 4, '".tanggal_indo($now)."')";
    ...
    $sql = "SELECT informasi.* FROM informasi WHERE id_jenis_informasi=4 LIMIT 1";
