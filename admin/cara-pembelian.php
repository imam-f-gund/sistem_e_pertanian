<?php
    ...
    if($_POST){
        if($_POST['method'] == 'tambah'){
            ...
            $sql = "INSERT INTO informasi (nama, keterangan, id_jenis_informasi , date) VALUES ('".$_POST['nama']."', '".$_POST['keterangan']."', 1, '".tanggal_indo($now)."')";

            $result = $mysqli->query($sql);
            header("location: cara-pembelian.php", true, 301);
    ...
    $sql = "SELECT informasi.* FROM informasi WHERE id_jenis_informasi=1 LIMIT 1";
