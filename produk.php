        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center">
                    ...
                    ?>
                    <a href="produk.php?query=<?=$data['id'];?>" style="text-decoration:none;color:black;"><div class="card mb-2"> <?php echo $data["nama"]; ?></div></a>
                ...
                <div class="col-md-8">
                    ...
                    <?php   
                        if (empty($query)) {
                            $conten = "select produk.id, produk.keterangan, produk.stok, produk.file, produk.nama, produk.harga, jenis_produk.nama as jenis, jenis_produk.satuan from produk  INNER JOIN jenis_produk on produk.id_jenis_produk = jenis_produk.id where produk.id_jenis_produk limit 20 ";
                               
                        }else{
                            $conten = "select produk.id, produk.keterangan, produk.stok, produk.file, produk.nama, produk.harga, jenis_produk.nama as jenis, jenis_produk.satuan from produk INNER JOIN jenis_produk on produk.id_jenis_produk = jenis_produk.id where produk.id_jenis_produk = '$query'  limit 20";
                        }
